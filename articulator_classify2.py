...
# Average CV score on the training set was: 0.7238916256157635
exported_pipeline = make_pipeline(
    ...
    ExtraTreesClassifier(bootstrap=False, criterion="gini", max_features=0.6500000000000001, min_samples_leaf=16, min_samples_split=12, n_estimators=100)
)
